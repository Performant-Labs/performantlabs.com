...
### Changed
- Release rebuild with updated Canvas recipe content.

## [1.1.3] - 2026-06-01

### Changed
- Recipe updates: Canvas component version fixes (1.3.1/1.3.2 pattern compatibility).
- Added `license_uuid` and `dripyard_uid` schema definitions for config validation.

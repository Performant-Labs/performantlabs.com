 ...
 * @endcode
 */
$settings['hash_salt'] = '81c2zNzMalVntLHSONmlFTCcKQ8a5i8-NHDDE0NuBmISbT-F_f4ashSnaaSGlCCd2tPIdEDNbA';
...
if (file_exists($app_root . '/' . $site_path . '/settings.local.php') && !isset($_ENV['PANTHEON_ENVIRONMENT'])) {
  ...
  switch ($_SERVER['PANTHEON_ENVIRONMENT']) {
    case 'dev':
      $config['environment_indicator.indicator']['name'] = 'Hosted Dev';
      $config['environment_indicator.indicator']['bg_color'] = '#d25e0f';
      $config['environment_indicator.indicator']['fg_color'] = '#ffffff';
      break;
    case 'test':
      $config['environment_indicator.indicator']['name'] = 'Hosted Test';
      $config['environment_indicator.indicator']['bg_color'] = '#c50707';
      $config['environment_indicator.indicator']['fg_color'] = '#ffffff';
      break;
    case 'live':
      $config['environment_indicator.indicator']['name'] = 'Hosted Live!';
  ...
  # Set up redis.
  #
  if (isset($_SERVER['PANTHEON_ENVIRONMENT']) && 1 == 2) {

...
describe('User registration and login tasks.', () => {
  ...
  // Forbidden.
  //
  it.skip('(ATK-CY-1000) Register with form.', { tags: ['@ATK-CY-1000', '@register-login', '@alters-db', '@smoke'] }, () => {
    ...
    cy.wait(1000);
    cy.expectEmail(user.userEmail, `Account details for ${user.userName}`);
  });
  ...
  it('(ATK-CY-1030) Reset password.', { tags: ['@ATK-CY-1030', '@register-login', '@smoke'] }, () => {
    ...
    // eslint-disable-next-line cypress/no-unnecessary-waiting
    cy.wait(1000);
    cy.expectEmail(user.userEmail, `Replacement login information for ${user.userName}`);

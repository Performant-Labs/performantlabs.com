...
describe('User registration and login tasks.', () => {
  ...
  it.only('(ATK-CY-1000) Register with form and confirm email with Ethereal.', { tags: ['ATK-CY-1000', 'register-login', 'alters-db', 'smoke'] }, () => {
    ...
    cy.contains('A welcome message with further')
  ...
  //
  it.skip('(ATK-CY-1010) Log in with form.', { tags: ['ATK-CY-1010', 'register-login', 'smoke'] }, () => {
  ...
  //
  it.skip('(ATK-CY-1012) Log in via ULI.', { tags: ['ATK-CY-1012', 'register-login', 'smoke'] }, () => {
  ...
  //
  it.skip('(ATK-CY-1020) Create user with Drush, delete by email.', { tags: ['ATK-CY-1020', 'register-login', 'smoke'] }, () => {
    cy.deleteUserWithEmail(userEtherealAccount.userEmail, [], ['--delete-content'])
  ...
  //
  it.skip('(ATK-CY-1021) Create user with Drush, delete by UID.', { tags: ['ATK-CY-1021', 'register-login', 'smoke'] }, () => {
    cy.deleteUserWithEmail(userEtherealAccount.userEmail, [], ['--delete-content'])
    cy.createUserWithUserObject(userEtherealAccount, [])
  ...
  //
  it.skip('(ATK-CY-1030) Reset password.', { tags: ['ATK-CY-1030', 'register-login', 'smoke'] }, () => {
    cy.deleteUserWithEmail(userEtherealAccount.userEmail, [], ['--delete-content'])
